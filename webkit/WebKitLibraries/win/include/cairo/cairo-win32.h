...
#if USE_WEBKIT_CHANGES
cairo_public struct ID3D10Device1 *
cairo_d2d_get_d3d10device_from_device(cairo_device_t *device);

cairo_public struct ID2D1Factory *
cairo_d2d_get_factory();

cairo_public cairo_device_t *
cairo_d2d_create_device_from_d3d11device(struct ID3D11Device *device);

cairo_public struct ID3D11Device *
cairo_d2d_get_d3d11device_from_device(cairo_device_t *device);

cairo_public struct ID2D1Factory1 *
cairo_d2d_get_factory1();

cairo_public struct ID2D1Device *
...
#else
cairo_public struct ID3D11Texture2D *cairo_d2d_surface_get_texture(cairo_surface_t *surf);
#endif
 ...
 */
cairo_public int cairo_d2d_surface_get_width(cairo_surface_t *surface);

/**
 * Get the height of the surface.
 */
cairo_public int cairo_d2d_surface_get_height(cairo_surface_t *surface);
#endif
