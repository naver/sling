...
#if WASLING(3854)
    // For sling, we avoid caching main resources to work around WebCore bugs, not for the same
    // reasons as chromium. The comment below is from the original patch.
